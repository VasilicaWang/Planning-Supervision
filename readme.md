...
-计划页是用户制定的计划列表，用户手动输入每条计划，并将计划保存到计划页面，\<br>
        ...
        ![](https://github.com/VisilicaWang/Planning-Supervision/raw/master/1-plan.gif) 
-成就页由一个日历组成，该日历上显示的是用户的每日计划完成情况，<br>
        ...
        ![](https://github.com/VisilicaWang/Planning-Supervision/raw/master/3-achievement.PNG) 
